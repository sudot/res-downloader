...
div.about
  div 1. 本软件免费、代码已开源，不会以任何形式收取费用。&nbsp;
    el-button(@click="jump('https://github.com/putyy/res-downloader')") 查看源码
  div 2. m3u8复制的链接如何使用? &nbsp;
    el-button(@click="jump('https://m3u8-down.gowas.cn/')") 在线下载
    el-button(@click="jump('https://www.baidu.com/s?wd=m3u8%E5%9C%A8%E7%BA%BF')") 在线播放
  div 3. 软件如何获取更新?  &nbsp;
    el-button(@click="jump('https://github.com/putyy/res-downloader')") 获取更新
  div 4. 问题反馈 &nbsp;
    el-button(@click="jump('https://github.com/putyy/res-downloader/issues')") 点击前往
  div.more
    pre {{more}}
